    ...
    <div>
        ...
        <div v-else>
            ...
            <div class="progress mb-2">
                ...
                aria-valuemin="0" 
                aria-valuemax="100">{{ pokemon.status.forca }}</div>
            </div>
            ...
            <div class="progress mb-2">
                <div class="progress-bar" role="progressbar" 
                    ...
                    aria-valuemin="0" 
                    aria-valuemax="100">{{ pokemon.status.agilidade }}</div>
            </div>
            ...
            <div class="progress mb-2">
                ...
                aria-valuemin="0" 
                aria-valuemax="100">{{ pokemon.status.ataque }}</div>
            </div>
            ...
            <div class="progress mb-2">
                ...
                aria-valuemin="0" 
                aria-valuemax="100">{{ pokemon.status.defesa }}</div>
            </div>
        </div>
    </div>
</template>
